package toby.exam10.user.main;

import org.springframework.context.ApplicationContext;
import org.springframework.context.support.GenericXmlApplicationContext;

import toby.exam1.user.domain.User;
import toby.exam10.user.dao.UserDao;

public class UserMain {
	public static void main(String[] args) throws Exception {
		ApplicationContext context = new GenericXmlApplicationContext("/toby/exam10/user/dao/applicationContext.xml");
